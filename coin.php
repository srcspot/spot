...
<body style='font-family: Yatra One;'>
 ...
 <title>aLi SaaDe</title>
 <body>
 <center>
     <?php
error_reporting(0);
echo "<br><br><center><h1>INSTA-UP COIN CHECKER AliToolS <span></span></h1></center>        <br><center><h1>BY - @TFS01 <span></span></h1></center><br>";
...
'access: '.$access,
'lng: en',
'api_key: ABCDEFGKLMNK',
"Nagent: null/02:00:00:00:00:00/'.$ts.'/$x16/null/$x40",
'cnt: unknown',
'version: 51',
'pkg: f2c6d7acybd35b030a1542f5eb589d5013340',
'aid: '.$x40,
...
<div class="container p-2 text-center">
			<button onclick="location.href='https://t.me/AAR3e'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-telegram"></i></button>
			<button onclick="location.href='https://www.instagram.com/9l.zu/ '" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-instagram"></i></button>
			<p class="text-muted p-5">copyright © aLi Vip 2022</p>
		</div>
